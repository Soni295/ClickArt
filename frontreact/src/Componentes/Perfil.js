...
const DatosDePerfil = (props) => {    
  ...
  useEffect( () => { 
    async function peticion() { 
      ...
      const url = 'http://localhost:8888/react/Perfil'
    ...
    <>      
      <Container fluid>
        <Row className="datos-perfil">
          ...
          <Col>
            <img className="img-perfil" src={props.infoDelPerfil.icono} alt='Icono' />
          </Col>
    ...
    <>
      ...
      <div>
        <VentanaPefil 
          visible = {galeria}
          texto={<Galeria
            conjuntoDeDibujos={props.infoDelPerfil.galeria} />}
