function verificar(parametros) {
  ...
  mensajeFinal.contrasena = vContrasenas(
    parametros.contrasena,
    parametros.contrasena2
  );
...
function vUsuario(usuario) {
  ...
  if (!usuario) mensaje = "complete este espacio";
    ...
    mensaje = "El usuario debe tener 6 caracteres minimo.";
  else if (usuario.length > 20)
    mensaje = "El usuario debe tener 20 caracteres maximo.";
  else mensaje = "";
...
function vNombre(nombre) {
  ...
  if (!nombre) mensaje = "complete este espacio";
    ...
    mensaje = "El nombre debe tener 6 caracteres minimo.";
  else if (nombre.length > 20)
    mensaje = "El nombre debe tener 20 caracteres maximo.";
  else mensaje = "";
...
function vContrasenas(contra1, contra2) {
  ...
  else if (contra1.length > 25)
    mensaje = "La contraseña debe tener 25 caracteres maximo.";
  else if (contra1.length <= 8)
    mensaje = "La contraseña debe tener 8 caracteres minimo.";
  else mensaje = "";
